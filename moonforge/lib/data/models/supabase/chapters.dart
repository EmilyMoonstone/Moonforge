...
class Chapters implements SupadartClass<Chapters> {
  final String id;
  ...
  static String get table_name => 'chapters';
  ...
  static List<Chapters> converter(List<Map<String, dynamic>> data) {
    return data.map(Chapters.fromJson).toList();
  }

  static Chapters converterSingle(Map<String, dynamic> data) {
  ...
  factory Chapters.fromJson(Map<String, dynamic> jsonn) {
    return Chapters(
